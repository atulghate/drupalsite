...
class __TwigTemplate_53bd8a176fcc46f7f7dc541a2d16c55185f20b6ef27d838bee559d04e5196056 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 0) &&  !twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 37)) &&  !twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 37))) {
    ...
    {
        return new Source("", "themes/electra/templates/menu/menu.html.twig", "C:\\xampp\\htdocs\\drupalsite\\themes\\electra\\templates\\menu\\menu.html.twig");
    }
